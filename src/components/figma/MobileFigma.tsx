...
// ATENÇÃO: Este componente foi gerado a partir do Figma (get_code)
// Ele serve como baseline visual 1:1 do layout mobile para conferência.
// Não está conectado ao fluxo real ainda; usaremos como referência.

const imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D812 = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/705cc0dc55d0d5a68388c772e2b6117b6c99cd0f.png";
const imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D814 = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/363d73ec33595dde3285b1f284098774998f5dac.png";
const imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D815 = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/012759f13f56517f1097b1fc4887ce210daa0750.png";
const imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D816 = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/8fca1f53bb6c91dfa7bb390285d6e25c4fdabb30.png";
const imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D817 = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/982534bd46b9e568691c0e5652a818ec5954a309.png";
const imgEmCima = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/c5bf77151a8866fa78db0df8dde0114c259578fa.png";
const imgAquamarine41 = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/6f46d9eac5f0e6717c6f749ddb7cef9b8551351a.png";
const img250127AlmapStillTeraTheTownFrenteV081 = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/0e4c4fe22e1cb5636a33462c5ac2022a711c0f36.png";
const imgEmbaixo = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/5112680c7f40d23f48f8876eb2dc44893c6f5a26.png";
const imgIconeSeta = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/7d81ad28ec29517142c61263569911e56b5bf8b1.svg";
const imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D813 = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/0aa0fffca858a707ff143e0af17fd4a0c981c966.svg";
const imgBotao = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/a4c6c6d2eaa486caf6f1c3c20b372c4a3e46e1e6.svg";
const imgLogoSetima = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/e3673b553c424c6b2648267f7e48b6843fc09b6b.svg";
const imgLogoSetima1 = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/7674cae785697e8381e7c52cd1935cc4128a49d2.svg";
const imgGroup = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/6225e7201df464b6a08b03339a7f5840b8630a79.svg";
const imgLinkedin = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/cee4173fa836977c0c829c200d5affe5043cbc21.svg";
const img250127AlmapStillTeraTheTownFrenteV82 = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/db7fef7f28a65df6eff5e06e19440a9b50550bf4.svg";
const imgVwConstelattion313206X4CacambaPsb1 = "/Users/saviobertolani/Downloads/Landing Page Sétima - NGI/src/figma/mobile-assets/85739bc9aff55a55c211190c1a7ee5e3be0295e8.svg";
		...
		<div className="relative size-full" data-name="Botao call" data-node-id="0:174">
			...
			<div className="absolute inset-[39.86%_88.44%_38.19%_6.67%]" data-name="icone seta" data-node-id="0:177">
				<div className="absolute bottom-[-4.47%] left-0 right-[-4.59%] top-[-4.47%]">
					<img alt="" className="block max-w-none size-full" src={imgIconeSeta} />
				</div>
			</div>
		</div>
	);
...
interface BackMobileProps {
	propriedade1?: "Frame 2" | "Frame 3" | "Frame 4" | "Frame 5" | "Frame 6";
}
...
function BackMobile({ propriedade1 = "Frame 2" }: BackMobileProps) {
	return (
		<div className="relative size-full" data-name="Propriedade 1=Frame 2" data-node-id="1:270">
			<div className="absolute contents left-0 top-0" data-node-id="1:196">
				<div className="absolute contents left-0 top-0" data-name="Mask group" data-node-id="1:177">
					<div
						className="absolute bg-center bg-cover bg-no-repeat h-[1008px] left-[-559px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[559px_58px] mask-size-[402px_874px] top-[-58px] w-[1577px]"
						data-name="ai_tools._Waist-up_portrait_American_shot_of_a_smiling_person_w_47b472c7-205a-4d66-bacf-38f70faa6d81 2"
						data-node-id="1:176"
						style={{ backgroundImage: `url('${imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D812}')`, maskImage: `url('${imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D813}')` }}
					/>
				</div>
				<div className="absolute contents left-[432px] top-0" data-name="Mask group" data-node-id="1:178">
					<div
						className="absolute bg-center bg-cover bg-no-repeat h-[910.843px] left-[-128px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[560px_13px] mask-size-[402px_874px] top-[-13px] w-[1425px]"
						data-name="ai_tools._Waist-up_portrait_American_shot_of_a_smiling_person_w_47b472c7-205a-4d66-bacf-38f70faa6d81 2"
						data-node-id="1:180"
						style={{ backgroundImage: `url('${imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D814}')`, maskImage: `url('${imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D813}')` }}
					/>
				</div>
				<div className="absolute contents left-[864px] top-0" data-name="Mask group" data-node-id="1:181">
					<div
						className="absolute bg-center bg-cover bg-no-repeat h-[907.008px] left-[283px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[581px_18px] mask-size-[402px_874px] top-[-18px] w-[1419px]"
						data-name="ai_tools._Waist-up_portrait_American_shot_of_a_smiling_person_w_47b472c7-205a-4d66-bacf-38f70faa6d81 2"
						data-node-id="1:183"
						style={{ backgroundImage: `url('${imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D815}')`, maskImage: `url('${imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D813}')` }}
					/>
				</div>
				<div className="absolute contents left-[1296px] top-0" data-name="Mask group" data-node-id="1:190">
					<div
						className="absolute bg-center bg-cover bg-no-repeat h-[907.008px] left-[1015px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[281px_18px] mask-size-[402px_874px] top-[-18px] w-[1419px]"
						data-name="ai_tools._Waist-up_portrait_American_shot_of_a_smiling_person_w_47b472c7-205a-4d66-bacf-38f70faa6d81 2"
						data-node-id="1:192"
						style={{ backgroundImage: `url('${imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D816}')`, maskImage: `url('${imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D813}')` }}
					/>
				</div>
				<div className="absolute contents left-[1728px] top-0" data-name="Mask group" data-node-id="1:193">
					<div
						className="absolute bg-center bg-cover bg-no-repeat h-[907.008px] left-[1099px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[629px_18px] mask-size-[402px_874px] top-[-18px] w-[1419px]"
						data-name="ai_tools._Waist-up_portrait_American_shot_of_a_smiling_person_w_47b472c7-205a-4d66-bacf-38f70faa6d81 2"
						data-node-id="1:195"
						style={{ backgroundImage: `url('${imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D817}')`, maskImage: `url('${imgAiToolsWaistUpPortraitAmericanShotOfASmilingPersonW47B472C7205A4D66Bacf38F70Faa6D813}')` }}
					/>
				</div>
			</div>
		</div>
...
interface AcordeonProps {
	propriedade1?: "Retraido" | "expandido";
}
...
export default function Mobile() {
	return (
		<div className="bg-white relative size-full" data-name="Mobile" data-node-id="1:75">
			<div className="absolute contents left-0 top-0" data-name="cabecalho" data-node-id="1:76">
				...
				<div className="absolute inset-[0.33%_84.32%_99.06%_5.97%]" data-name="logo setima" data-node-id="1:79">
					<img alt="" className="block max-w-none size-full" src={imgLogoSetima} />
				</div>
			</div>
			<div className="absolute contents left-0 top-[5514px]" data-name="Bloco 08" data-node-id="1:575">
				...
				<div className="absolute contents inset-[97.41%_13.64%_1.73%_57.46%]" data-name="redes" data-node-id="17:131">
					...
					<div className="absolute inset-[97.41%_13.64%_1.73%_74.06%]" data-name="linkedin" data-node-id="17:137">
			...
			<div className="absolute contents left-[-248px] top-[3906px]" data-name="Bloco 06" data-node-id="1:331">
			...
			<div className="absolute contents left-0 top-[3458px]" data-name="Bloco 05" data-node-id="1:327">
			...
			<div className="absolute contents left-0 top-[2322px]" data-name="Bloco 04" data-node-id="1:311">
				<div className="absolute bg-[#13171a] h-[600px] left-0 top-[2858px] w-[402px]" data-name="background" data-node-id="1:312" />
				<div className="absolute contents left-0 top-[2322px]" data-name="imagem grande" data-node-id="1:313">
					<div
				...
				<div className="absolute contents left-[24px] top-[2889px]" data-name="imagens carrossel" data-node-id="1:316">
			...
			<div className="absolute contents left-0 top-[1648px]" data-name="Bloco 03" data-node-id="1:306">
			...
			<div className="absolute contents left-0 top-[874px]" data-name="Bloco 02" data-node-id="1:297">
			...
			<div className="absolute contents left-0 top-0" data-name="Bloco 01" data-node-id="1:172">
				<div className="absolute h-[874px] left-0 overflow-clip top-0 w-[402px]" data-name="back mobile" data-node-id="1:280">
					<BackMobile />
				</div>
				<div className="absolute contents left-0 top-[701px]" data-name="Transparências" data-node-id="1:145">
				...
				<div className="absolute h-[36px] top-[804px] w-[315px]" data-name="Botao call" data-node-id="1:148" style={{ left: "calc(8.333% + 9.5px)" }}>
					<BotaoCall />
				</div>
				<div className="absolute font-['Ubuntu:Light',_sans-serif] leading-[1.077] not-italic text-[30px] text-center text-nowrap text-white top-[652.9px] translate-x-[-50%] whitespace-pre" data-node-id="1:149" style={{ left: "calc(8.333% + 167px)" }}>
					<p className="mb-0">A NOVA MATEMÁTICA</p>
					<p className="mb-0">DO MARKETING:</p>
					<p className="mb-0">MENOS CUSTO,</p>
					<p>MAIS IMPACTO.</p>
				</div>
				<div className="absolute font-['Ubuntu:Medium',_sans-serif] leading-[0] not-italic text-[15px] text-center text-nowrap text-white top-[631px] translate-x-[-50%]" data-node-id="1:150" style={{ left: "calc(25% + 100.777px)" }}>
					<p className="leading-[normal] whitespace-pre">SOMOS UMA CONTENT-TECH</p>
				</div>
			</div>
		</div>
	);
